...
cd "$MESON_BUILD_ROOT"
meson compile  > "$MESON_BUILD_ROOT"/gcc-build.log 
ninja clang-tidy > "$MESON_BUILD_ROOT"/clang-tidy-report
meson compile --clean
cd "$MESON_SOURCE_ROOT"
cppcheck -v --enable=all --xml -f --report-progress -I /usr/include/c++/10.2.0/ -I/usr/include/c++/10.2.0/tr1/ -I /usr/include/ -I /usr/include/c++/10.2.0/x86_64-pc-linux-gnu/ -I /usr/include/linux/ -I /usr/include/libpng16/ -I /usr/lib/qt/mkspecs/linux-g++/ -I /usr/include/qt/QtCore/ -I /usr/include/qt/QtGui/ -I /usr/include/qt/QtNetwork/ -I /usr/include/qt/QtPrintSupport/ -I /usr/include/qt/QtSql/ -I /usr/include/qt/QtWidgets -I /usr/include/qt/ -I "$MESON_SOURCE_ROOT"/include/ -I /usr/lib/zig/libc/include/x86_64-linux-gnux32/ -D__cplusplus="201703L" -D"__has_include()" . 2>"$MESON_BUILD_ROOT"/cppcheck-report.xml
