...
static const char errc_names_cd[][5] = {"BLER", "E11", "E21", "E31",
                                        "E12",  "E22", "E32", "UNCR"
                                       };
static const char errc_names_dvd[][5] = {"---", "PIE", "PI8", "PIF",
                                         "POE", "PO8", "POF", "UNCR"
                                        };
static const char errc_names_bd[][5] = {"---", "LDC", "---", "---",
                                        "BIS", "---", "---", "UNCR"
                                       };
...
public:
    cd_errc()
        : bler(0), e11(0), e21(0), e31(0), e12(0), e22(0), e32(0), uncr(0) {};
    ~cd_errc() {};
