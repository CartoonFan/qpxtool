...
private:
  ...
  QCheckBox *ck_hcdr, *ck_ss, *ck_spdrd, *ck_bitset, *ck_bitset_dl,
      *ck_simulplus;
...
private:
  ...
  QLabel *h_speed, *h_access, *h_tray;
  // R/W Speeds
  QLabel *spdr, *spdw, *spdc, *spdd;
  QComboBox *box_rcd, *box_wcd, *box_rdvd, *box_wdvd;
  // Access time
  QButtonGroup *grp_access;
  QRadioButton *a_slow, *a_fast;
  // Tray speed
...
private:
  ...
  QRadioButton *rb_as_on, *rb_as_off, *rb_as_auto, *rb_as_forced;
  QPushButton *pb_asdb;
  // MQCK
  QGroupBox *box_mqck;
  ...
  QRadioButton *rb_mqck_q, *rb_mqck_a;
  QLabel *lmqck_spd;
  QComboBox *bmqck_spd;
  QPushButton *pb_mqck;
  QLabel *lmqck_res;
...
private:
  ...
  QTreeWidget *tree;
  QPushButton *pb_act, *pb_deact, *pb_del, *pb_clear;

  // Strategy creation
  QGroupBox *box_ascre;
  QGridLayout *layout_ascre;
  QGroupBox *grp_ascre_mode, *grp_ascre_act;
  QBoxLayout *layout_crem, *layout_crea;
  QRadioButton *rb_ascre_quick, *rb_ascre_full, *rb_ascre_add,
      *rb_ascre_replace;
