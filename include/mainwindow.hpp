...
private:
  ...
  QToolBar *toolbar;
  QAction *act_exit, *act_pref, *act_save, *act_save_db, *act_load,
      *act_load_db, *act_export, *act_report, *act_print, *act_scanbus,
      *act_minfo, *act_devctl, *act_test, *act_stop, *act_about;
