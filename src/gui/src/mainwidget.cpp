...
#include "tab_errc.hpp"
#include "tab_fete.hpp"
#include "tab_jb.hpp"
#include "tab_mediainfo.hpp"
#include "tab_ta.hpp"
...
QPxMainWidget::QPxMainWidget(QPxSettings *iset, devlist *idev, QWidget *p)
  ...
  addTabButton(pb, ":images/test_rt.png", "Read Transfer", tabidx,
               layout_buttons);
  ...
  addTabButton(pb, ":images/test_wt.png", "Write Transfer", tabidx,
               layout_buttons);
  ...
  addTabButton(pb, ":images/test_errc.png", "Error Correction", tabidx,
               layout_buttons);
  ...
  addTabButton(pb, ":images/test_jb.png", "Jitter/Asymmetry", tabidx,
               layout_buttons);
  ...
  addTabButton(pb, ":images/test_ta.png", "Time Analyser", tabidx,
               layout_buttons);
