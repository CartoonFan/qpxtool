...
CREATE TABLE dev_models (
    ...
    CONSTRAINT dev_models_ref_vendors FOREIGN KEY (id_vendor) REFERENCES dev_vendors (id) MATCH
...
CREATE TABLE reports (
    ...
    CONSTRAINT reports_ref_media FOREIGN KEY (id_media_type) REFERENCES media_types (id) MATCH
    FULL ON UPDATE RESTRICT ON DELETE RESTRICT,
    CONSTRAINT reports_ref_device FOREIGN KEY (dev_id) REFERENCES dev_models (id) MATCH
    FULL ON UPDATE RESTRICT ON DELETE RESTRICT,
