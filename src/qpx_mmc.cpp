 ...
 *
 * original version of CD-R(W) manufacturer identification code got from
 * cdrecord, (C) Joerg Schilling
 *
...
int print_opcode(unsigned char opcode) {
    ...
    case 0x00:
        strcpy(str, "SPC_TEST_UNIT_READY                           ");
        break;
    case 0x03:
        strcpy(str, "SPC_REQUEST_SENSE                             ");
        break;
    case 0x04:
        strcpy(str, "MMC_FORMAT_UNIT                               ");
        break;

    case 0x12:
        strcpy(str, "SPC_INQUIRY                                   ");
        break;
    case 0x15:
        strcpy(str, "MMC_MODE_SELECT6                              ");
        break;
    case 0x16:
        strcpy(str, "SPC_RESERVE_6                                 ");
        break;
    case 0x17:
        strcpy(str, "SPC_RELEASE_6                                 ");
        break;
    case 0x1A:
        strcpy(str, "MMC_MODE_SENSE6                               ");
        break;
    case 0x1B:
        strcpy(str, "MMC_START_STOP_UNIT                           ");
        break;
    case 0x1C:
        strcpy(str, "SPC_RECEIVE_DIAGNOSTIC_RESULTS                ");
        break;
    case 0x1D:
        strcpy(str, "SPC_SEND_DIAGNOSTIC                           ");
        break;
    case 0x1E:
        strcpy(str, "SPC_PREVENT_ALLOW_MEDIUM_REMIVAL              ");
        break;

    case 0x23:
        strcpy(str, "MMC_READ_FORMAT_CAPACITIES                    ");
        break;
    case 0x25:
        strcpy(str, "MMC_READ_RECORDED_CAPACITY                    ");
        break;
    case 0x28:
        strcpy(str, "MMC_READ                                      ");
        break;
    case 0x2A:
        strcpy(str, "MMC_WRITE                                     ");
        break;
    case 0x2B:
        strcpy(str, "MMC_SEEK                                      ");
        break;
    case 0x2E:
        strcpy(str, "MMC_WRITE_AND_VERIFY                          ");
        break;
    case 0x2F:
        strcpy(str, "MMC_VERIFY                                    ");
        break;

    case 0x35:
        strcpy(str, "MMC_SYNC_CACHE                                ");
        break;
    case 0x3B:
        strcpy(str, "SPC_WRITE_BUFFER                              ");
        break;
    case 0x3C:
        strcpy(str, "SPC_READ_BUFFER                               ");
        break;

    case 0x42:
        strcpy(str, "MMC_READ_SUB_CHANNEL                          ");
        break;
    case 0x43:
        strcpy(str, "MMC_READ_TOC_PMA_ATIP                         ");
        break;
    case 0x44:
        strcpy(str, "MMC_READ_HEADER                               ");
        break;
    case 0x45:
        strcpy(str, "MMC_PLAY_AUDIO                                ");
        break;
    case 0x46:
        strcpy(str, "MMC_GET_CONFIGURATION                         ");
        break;
    case 0x47:
        strcpy(str, "MMC_PLAY_AUDIO_MSF                            ");
        break;
    case 0x4A:
        strcpy(str, "MMC_GET_EVENT_STATUS_NOTIFICATION             ");
        break;
    case 0x4B:
        strcpy(str, "MMC_PAUSE_RESUME                              ");
        break;
    case 0x4C:
        strcpy(str, "SPC_LOG_SELECT                                ");
        break;
    case 0x4D:
        strcpy(str, "SPC_LOG_SENSE                                 ");
        break;
    case 0x4E:
        strcpy(str, "MMC_STOP_PLAY_SCAN                            ");
        break;

    case 0x51:
        strcpy(str, "MMC_READ_DISC_INFORMATION                     ");
        break;
    case 0x52:
        strcpy(str, "MMC_READ_TRACK_INFORMATION                    ");
        break;
    case 0x53:
        strcpy(str, "MMC_RESERVE_TRACK                             ");
        break;
    case 0x54:
        strcpy(str, "MMC_SEND_OPC_INFORMATION                      ");
        break;
    case 0x55:
        strcpy(str, "MMC_MODE_SELECT10                             ");
        break;
    case 0x56:
        strcpy(str, "SPC_RESERVE_10                                ");
        break;
    case 0x57:
        strcpy(str, "SPC_RELEASE_10                                ");
        break;
    case 0x58:
        strcpy(str, "MMC_REPAIR_TRACK                              ");
        break;
    case 0x59:
        strcpy(str, "MMC_READ_MASTER_CUE                           ");
        break;
    case 0x5A:
        strcpy(str, "MMC_MODE_SENSE10                              ");
        break;
    case 0x5B:
        strcpy(str, "MMC_CLOSE_TRACK_SESSION                       ");
        break;
    case 0x5C:
        strcpy(str, "MMC_READ_BUFFER_CAPACITY                      ");
        break;
    case 0x5D:
        strcpy(str, "MMC_SEND_CUE_SHEET                            ");
        break;
    case 0x5E:
        strcpy(str, "SPC_PERSISTENT_RESERVE_IN                     ");
        break;
    case 0x5F:
        strcpy(str, "SPC_PERSISTENT_RESERVE_OUT                    ");
        break;

    case 0x83:
        strcpy(str, "SPC_EXTENDED_COPY                             ");
        break;
    case 0x84:
        strcpy(str, "SPC_RECEIVE_COPY_RESULTS                      ");
        break;
    case 0x86:
        strcpy(str, "SPC_ACCESS_CONTROL_IN                         ");
        break;
    case 0x87:
        strcpy(str, "SPC_ACCESS_CONTROL_OUT                        ");
        break;
    case 0x8C:
        strcpy(str, "SPC_READ_ATTRIBUTE                            ");
        break;
    case 0x8D:
        strcpy(str, "SPC_WRITE_ATTRIBUTE                           ");
        break;

    case 0xA0:
        strcpy(str, "SPC_REPORT_LUNS                               ");
        break;
    case 0xA1:
        strcpy(str, "MMC_BLANK                                     ");
        break;
    case 0xA2:
        strcpy(str, "MMC_SEND_EVENT     / SPC_SECURITY_PROTOCOL_IN ");
        break;
    case 0xA3:
        strcpy(str, "MMC_SEND_KEY                                  ");
        break;
    case 0xA4:
        strcpy(str, "MMC_REPORT_KEY                                ");
        break;
    case 0xA5:
        strcpy(str, "MMC_PLAY_AUDIO_12                             ");
        break;
    case 0xA6:
        strcpy(str, "MMC_LOAD_UNLOAD                               ");
        break;
    case 0xA7:
        strcpy(str, "MMC_SET_READ_AHEAD / SMC_MOVE_MEDIUM_ATTACHED ");
        break;
    case 0xA8:
        strcpy(str, "MMC_READ_DVD                                  ");
        break;
    case 0xAC:
        strcpy(str, "MMC_GET_PERFORMANCE                           ");
        break;
    case 0xAD:
        strcpy(str, "MMC_READ_DVD_STRUCTURE                        ");
        break;

    case 0xB4:
        strcpy(str, "SMC_READ_ELEMENT_STATUS_ATTACHED              ");
        break;
    case 0xB5:
        strcpy(str, "SPC_SECURITY_PROTOCOL_OUT                     ");
        break;
    case 0xB6:
        strcpy(str, "MMC_SET_STREAMING                             ");
        break;
    case 0xB9:
        strcpy(str, "MMC_READ_CD_MSF                               ");
        break;
    case 0xBA:
        strcpy(str, "MMC_SCAN                                      ");
        break;
    case 0xBB:
        strcpy(str, "MMC_SET_SPEED                                 ");
        break;
    case 0xBC:
        strcpy(str, "MMC_PLAY_CD          / SCC_SPARE_IN           ");
        break;
    case 0xBD:
        strcpy(str, "MMC_MECHANISM_STATUS / SCC_SPARE_OUT          ");
        break;
    case 0xBE:
        strcpy(str, "MMC_READ_CD          / SCC_VOLUME_SET_IN      ");
        break;
    case 0xBF:
        strcpy(str, "SCC_VOLUME_SET_OUT                            ");
        break;

    case 0xD4:
        strcpy(str, "PLEXTOR_GET_AUTH                              ");
        break;
    case 0xD5:
        strcpy(str, "PLEXTOR_SEND_AUTH                             ");
        break;

    // const char  = 0xD8;

    case 0xE3:
        strcpy(str, "PLEXTOR_ERASER                                ");
        break;
    case 0xE4:
        strcpy(str, "PLEXTOR_AS_RD                                 ");
        break;
    case 0xE5:
        strcpy(str, "PLEXTOR_AS_WR                                 ");
        break;

    case 0xE7:
        strcpy(str, "SBC_FLUSH_CACHE                               ");
        break;

    case 0xE9:
        strcpy(str, "PLEXTOR_MODE                                  ");
        break;
    case 0xEA:
        strcpy(str, "PLEXTOR_QCHECK                                ");
        break;
    case 0xEB:
        strcpy(str, "PLEXTOR_PREC_SPD                              ");
        break;
    case 0xED:
        strcpy(str, "PLEXTOR_MODE2                                 ");
        break;

    case 0xEE:
        strcpy(str, "PLEXTOR_RESTART                               ");
        break;
    //		case 0xEF: strcpy(str,"PLEXTOR     REBOOT ??? "); break;

    case 0xF1:
        strcpy(str, "PLEXTOR_EEPROM_READ                           ");
        break;

    case 0xF3:
        strcpy(str, "PLEXTOR_SCAN_TA_FETE                          ");
        break;
    case 0xF5:
        strcpy(str, "PLEXTOR_FETE_READOUT                          ");
        break;
    default:
        strcpy(str, "*unknown*                                     ");
    }
...
int scanbus(int vendor_mask) {
    ...
    for (i = 0; strlen(_devtbl[i].name) > 0; i++) {
        if (!probe_drive(_devtbl[i].name, drvcnt))
            drvcnt++;
    }
#else
    for (i = 0; strlen(_devtbl[i].name) > 0; i++) {
...
void spinup(drive_info *drive, unsigned char secs) {
    ...
    for (et = getmsecs(); !err && (et - st) < (secs * 1000); et = getmsecs()) {
        ...
        if (use_readcd)
            err = read_cd(drive, drive->rd_buf, lba, blk, 0xF8);
        else
            err = read(drive, drive->rd_buf, lba, blk);
    }

    if (use_readcd)
        read_cd(drive, drive->rd_buf, 0, 1, 0xF8);
    else
...
int inquiry(drive_info *drive) {
    ...
    if (add_len >= 91) {
        ...
        if (drive->err) {
            if (!drive->silent)
                sperror("INQUIRY ADD", drive->err);
        } else {
            for (i = 0; i < 8; i++)
                drive->ver_id[i] = ntoh16(drive->rd_buf + 58 + i * 2);
        }
    }
    if ((drive->rd_buf[0] & 0x1F) != 5)
        return ERR_NO_MMC;
    drive->mmc = 1;
    convert_to_ID(drive);
    return 0;
...
int isYamaha(drive_info *drive) {
    return !strncmp(drive->ven, "YAMAHA  ", 8);
}

int isPioneer(drive_info *drive) {
    return !strncmp(drive->ven, "PIONEER ", 8);
}
...
int wait_unit_ready(drive_info *drive, int secs, bool need_media) {
    ...
    for (et = getmsecs(); (et - st) < ((long)secs * 1000); et = getmsecs()) {
        if (!drive->silent)
            printf("Remaining: %.3f sec...\r", secs - ((et - st) / 1000.0));
        if (!test_unit_ready(drive))
            return 0;
        if (!need_media) {
            if (drive->err == 0x23A01)
                return 0;
...
int wait_fix(drive_info *drive, int secs) {
    ...
    for (et = getmsecs(); (et - st) < ((long)secs * 1000); et = getmsecs()) {
        if (!drive->silent)
            printf("Remaining: %.3f sec...\r", secs - ((et - st) / 1000.0));
        if (!read_disc_info(drive, 16))
            return 0;
        //  if not SC_NOT_READY or SC_UNIT_ATTENTION return
        if ((drive->err & 0xF0000) != 0x20000 && (drive->err & 0xF0000) != 0x60000)
            return 1;
        msleep(100);
        //		i++;
    }
...
int check_burnfree(drive_info *drive) {
    if (mode_sense(drive, MODE_PAGE_WRITE_PARAMETERS, 0, 60))
        return -1;
...
int reserve_track(drive_info *drive, uint32_t size) {
    ...
    if ((drive->err = drive->cmd.transport(NONE, NULL, 0))) {
        sperror("RESERVE_TRACK", drive->err);
        return (drive->err);
    }
    return 0;
}
...
int close_track_session(drive_info *drive, int n, int cltype) {
    ...
    drive->cmd[5] = n & 0xFF;
    if ((drive->err = drive->cmd.transport(NONE, NULL, 0))) {
        sperror("MMC_CLOSE_TRACK_SESSION", drive->err);
        return (drive->err);
    }
    return 0;
}
...
int request_sense(drive_info *drive, char add) {
    ...
    if ((drive->err = drive->cmd.transport(READ, drive->rd_buf, 0x12))) {
        if (!drive->silent)
            sperror("REQUEST_SENSE", drive->err);
        return (drive->err);
    }
    return 0;
}
...
int mode_sense(drive_info *drive, int page, int page_control, int dest_len) {
    ...
    if ((drive->err = drive->cmd.transport(READ, drive->rd_buf, dest_len))) {
        if (!drive->silent)
            sperror("MODE_SENSE(10)", drive->err);
        return (drive->err);
    }
    return 0;
}
...
int mode_select(drive_info *drive, int dest_len) {
    ...
    */
    ...
    if ((drive->err = drive->cmd.transport(WRITE, drive->rd_buf, dest_len))) {
        if (!drive->silent)
            sperror("MODE_SELECT(10)", drive->err);
        return (drive->err);
    }
...
int get_configuration(drive_info *drive, int feature_number,
                      unsigned int *data_length, int *current,
    ...
    if (data_length) {
        *data_length = ntoh32u(drive->rd_buf);
        ...
        if (*data_length > 4)
            if ((drive->err =
                        drive->cmd.transport(READ, drive->rd_buf, *data_length + 4))) {
                if (!drive->silent)
...
void detect_iface(drive_info *drive) {
    ...
    drive->iface_id = (drive->rd_buf[12] << 12) | (drive->rd_buf[13] << 8) |
                      (drive->rd_buf[14] << 4) | drive->rd_buf[15];
...
int write_buffer(drive_info *drive, uint8_t mode, uint8_t buff_id,
    ...
    if ((drive->err = drive->cmd.transport(WRITE, drive->rd_buf, len))) {
        if (!drive->silent)
            sperror("WRITE_BUFFER", drive->err);
        return (drive->err);
    }
...
int read_buffer(drive_info *drive, uint8_t mode, uint8_t buff_id, uint32_t offs,
                uint32_t len) {
...
int read_echo_buffer_size(drive_info *drive) {
    ...
    if ((drive->err = drive->cmd.transport(READ, drive->rd_buf, 4))) {
        if (!drive->silent)
            sperror("READ_ECHO_BUFFER_SIZE", drive->err);
        return (0);
    }
...
int test_dma_speed(drive_info *drive, long msecs) {
    ...
    for (et = getmsecs(); (et - st) < (msecs); et = getmsecs()) {
        if (write_buffer(drive, 0x0A, 0, 0, buf_size)) {
            if (!drive->silent)
                printf("WRITE BUFFER error! DMA speed test aborted!\n");
            drive->silent++;
            return 1;
        }
        if (read_buffer(drive, 0x0A, 0, 0, buf_size)) {
            if (!drive->silent)
                printf("READ BUFFER error! DMA speed test aborted!\n");
            drive->silent++;
            return 1;
        }
        cnt++;
...
int flush_cache(drive_info *drive, bool IMMED) {
    ...
    if ((drive->err = drive->cmd.transport(NONE, NULL, 0))) {
        if (!drive->silent)
            sperror("SBC_FLUSH_CACHE", drive->err);
        return (drive->err);
    }
...
int get_cache(drive_info *drive, bool *rd, bool *wr) {
    bool re, we;
    if (mode_sense(drive, MODE_PAGE_CACHING, 0, 20) ||
            drive->rd_buf[8] != MODE_PAGE_CACHING)
        return 1;
...
int get_mode_pages_list(drive_info *drive) {
    ...
    if (mode_sense(drive, 0x3F, 2, 0x4000))
        return 1;
    ...
    for (i = 8; (i < len) && (i < 0x4000); i += ml) {
        ...
        ii = 0;
        while ((MODE_PAGES[ii].id != mn) && (MODE_PAGES[ii].id < 0x3F))
            ii++;
        if (!drive->silent) {
...
int get_features_list(drive_info *drive) {
    ...
    if (get_configuration(drive, 0, &len, NULL, 0))
        return 1;
#if 0
//#ifdef FEATURE_DEBUG
    printf("data len: %4X (%4d), Header:\n", len, len);
    ...
    for (i = 8; (i < len) && (i < 0x8000); i += fl) {
        ...
        ii = 0;
        while ((FEATURES[ii].id != fn) && (FEATURES[ii].id < 0xFFFF))
            ii++;
        if (!drive->silent) {
...
int get_profiles_list(drive_info *drive) {
    ...
    if (get_configuration(drive, FEATURE_PROFILE_LIST, &len, NULL, 0x02))
        return 1;

    for (i = 0; (i < len - 8) && (i < 0x8000); i += 4) {
        profile = ntoh16u(drive->rd_buf + i + 12);
        ii = 0;
        while ((PROFILES[ii].id != profile) && (PROFILES[ii].id < 0xFFFF))
            ii++;
        if (!drive->silent)
    ...
    if (drive->mmc > 1) {
        ...
        if (len >= 0x0C) {
            ...
            if (drive->rd_buf[12] & 0x01)
                drive->wr_capabilities |= DEVICE_MRW;
            if (drive->rd_buf[12] & 0x02)
                drive->rd_capabilities |= DEVICE_MRW_DVD;
            if (drive->rd_buf[12] & 0x04)
                drive->wr_capabilities |= DEVICE_MRW_DVD;
        }
        get_configuration(drive, FEATURE_CD_READ, &len,
                          NULL); // LU can operate with CD's
        if (len >= 0x0C) {
            //			drive->rd_capabilities|=DEVICE_CD_ROM;
            if (drive->rd_buf[12] & 0x1)
                drive->capabilities |= CAP_CD_TEXT;
            if (drive->rd_buf[12] & 0x2)
                drive->capabilities |= CAP_C2;
        }
        get_configuration(drive, FEATURE_DDCD_READ, &len,
                          NULL); // LU can Reed/Write DDCD's
        if (len >= 0x0C) {
            ...
            if (len >= 0x0C)
                drive->wr_capabilities |= DEVICE_DDCD_R;
            get_configuration(drive, FEATURE_DDCD_RW_WRITE, &len, NULL);
            if (len >= 0x0C)
                drive->wr_capabilities |= DEVICE_DDCD_RW;
        }
        get_configuration(drive, FEATURE_DVD_READ, &len,
                          NULL); // LU can operate with DVD's
        if (len >= 0x08) {
            if ((drive->rd_buf[10] >> 2) > 0)
                drive->mmc = 5;
            if (len >= 0x0C) {
                if (drive->rd_buf[14] & 0x01)
                    drive->rd_capabilities |= DEVICE_DVD_R_DL;
                if (drive->rd_buf[14] & 0x02)
                    drive->rd_capabilities |= DEVICE_DVD_RW_DL;
            }
            get_configuration(drive, FEATURE_DVD_CPRM, &len, NULL);
            if (len >= 0x08)
                drive->capabilities |= CAP_DVD_CPRM;
            get_configuration(drive, FEATURE_DVD_CSS, &len, NULL);
            if (len >= 0x08)
                drive->capabilities |= CAP_DVD_CSS;
            ...
            if (len >= 0x08) {
                ...
                if (len >= 0x0C) {
                    if (drive->rd_buf[12] & 0x02)
                        drive->wr_capabilities |= DEVICE_DVD_RW;
                    if (drive->rd_buf[12] & 0x04)
                        drive->capabilities |= CAP_TEST_WRITE_DVD;
                    // if (drive->rd_buf[12]&0x08)
                    // drive->wr_capabilities|=DEVICE_DVD_R_DL_SEQ;
                    if (drive->rd_buf[12] & 0x08)
                        drive->wr_capabilities |= DEVICE_DVD_R_DL;
                }
            }
        ...
        if (drive->wr_capabilities & DEVICE_DVD_RW)
            drive->rd_capabilities |= DEVICE_DVD_RW;
        if (drive->wr_capabilities & DEVICE_DVD_R_DL)
            drive->rd_capabilities |= DEVICE_DVD_R_DL;
        get_configuration(drive, FEATURE_BD_READ, &len, NULL);
        if ((len >= 0x08) && (drive->rd_buf[11] >= 28)) {
            if (drive->rd_buf[16] | drive->rd_buf[17] | drive->rd_buf[18] |
                    drive->rd_buf[19] | drive->rd_buf[20] | drive->rd_buf[21] |
                    drive->rd_buf[22] | drive->rd_buf[23])
                drive->rd_capabilities |= (DEVICE_BD_RE);
            if (drive->rd_buf[24] | drive->rd_buf[25] | drive->rd_buf[26] |
                    drive->rd_buf[27] | drive->rd_buf[28] | drive->rd_buf[29] |
                    drive->rd_buf[30] | drive->rd_buf[31])
                drive->rd_capabilities |= (DEVICE_BD_R);
            if (drive->rd_buf[32] | drive->rd_buf[33] | drive->rd_buf[34] |
                    drive->rd_buf[35] | drive->rd_buf[36] | drive->rd_buf[37] |
                    drive->rd_buf[38] | drive->rd_buf[39])
                drive->rd_capabilities |= (DEVICE_BD_ROM);
        }
        ...
        if ((len >= 0x08)) {
            ...
            if ((len >= 0x0C)) {
                if (drive->rd_buf[12] & 0x01)
                    drive->rd_capabilities |= DEVICE_HDDVD_R;
                if (drive->rd_buf[14] & 0x01)
                    drive->rd_capabilities |= DEVICE_HDDVD_RAM;
            }
        }
        get_configuration(drive, FEATURE_HDDVD_WRITE, &len, NULL);
        if ((len >= 0x0C)) {
            if (drive->rd_buf[12] & 0x01)
                drive->wr_capabilities |= DEVICE_HDDVD_R;
            if (drive->rd_buf[14] & 0x01)
                drive->wr_capabilities |= DEVICE_HDDVD_RAM;
        }
        if (!drive->silent)
            printf("** Device is MMC-%d\n", drive->mmc);
    }
}
...
int read_atip(drive_info *drive) {
    ...
    if (!drive->silent) {
        ...
        for (i = 0; i < (min(size, 4)); i++)
            printf(" %3d (%02X)", drive->media.ATIP[i], drive->media.ATIP[i]);
        if (size > 4)
            for (i = 0; i < (size - 4); i++) {
                if (!(i % 8))
                    printf("\n");
                    ...
                    printf("      ");
                printf(" %3d (%02X)", drive->media.ATIP[i + 4] & 0xFF,
                       drive->media.ATIP[i + 4] & 0xFF);
            }
        printf("\n");
    }
    return 0;
...
int read_toc(drive_info *drive) {
    ...
    if (!drive->silent) {
        printf("TOC (%d bytes):\n", size);
        for (i = 0; i < (min(size, 4)); i++)
            printf(" %3d (%02X)", drive->rd_buf[i] & 0xFF, drive->rd_buf[i] & 0xFF);
        if (size > 4)
            for (i = 0; i < (size - 4); i++) {
                if (!(i % 8))
                    printf("\n");
                    ...
                    printf("      ");
                printf(" %3d (%02X)", drive->rd_buf[i + 4] & 0xFF,
                       drive->rd_buf[i + 4] & 0xFF);
            }
        printf("\n");
    }
    return 0;
...
int read_disc_info(drive_info *drive, int len) {
    ...
    if ((drive->err = drive->cmd.transport(READ, drive->rd_buf, len))) {
        if (!drive->silent)
            sperror("READ_DISC_INFO", drive->err);
        return 1;
    }
    return 0;
}
...
int read_track_info(drive_info *drive, trk *track, unsigned int track_n) {
    ...
    if ((drive->err = drive->cmd.transport(READ, drive->rd_buf, size))) {
        if (!drive->silent)
            sperror("READ_TRACK_INFO", drive->err);
        return 1;
    }
    ...
    track->session =
        ((drive->rd_buf[33] & 0xFF) << 8) | (drive->rd_buf[3] & 0xFF);
...
int get_track_list(drive_info *drive) {
    ...
    if (read_track_info(drive, &drive->media.track[0], 1)) {
        ...
        for (i = 0; i < drive->media.tracks; i++) {
            ...
            drive->media.track[i].size =
                drive->media.track[i].last - drive->media.track[i].start + 1;
            ...
            lba2msf(drive->media.track[i].next_writable,
                    &drive->media.track[i].msf_next);
            ...
            //			lba2msf(drive->media.track[i].end,
            //&drive->media.track[i].msf_end);
    ...
    if (!drive->silent)
        printf("tracks: %d\n", drive->media.tracks);
    if ((drive->media.tracks) && (!drive->silent))
        for (i = 0; i < drive->media.tracks; i++) {
...
int read_capacity(drive_info *drive) {
    ...
    if ((drive->cmd.transport(READ, data, 8))) {
        if (!drive->silent)
            sperror("READ_CAPACITY", drive->err);
    ...
    /*
        ...
        //if (0) {
                if (((drive->media.last_lead_out >> 24) & 0xFF ) == 0xFF) {
                        ...
                        drive->media.capacity_free = drive->media.last_lead_out -
    drive->media.capacity - 150 - 2;
                        lba2msf(drive->media.capacity_free,&drive->media.capacity_free_msf);
                        return 0;
                }
...
int read_capacity_total(drive_info *drive) {
    ...
    if (drive->media.type & DISC_CD) {
        ...
        if (!drive->media.ATIP_size) {
            drive->media.capacity_total =
                drive->media.capacity + drive->media.capacity_free;
            return 0;
        } else {
        ...
        if (drive->media.type & (DISC_DVDmRWR | DISC_DVDmRWS | DISC_DVDmRWDL)) {
            ...
            if ((drive->err = drive->cmd.transport(READ, drive->rd_buf, len))) {
                if (!drive->silent)
                    sperror("READ_FORMAT_CAPACITIES", drive->err);
...
read_total_dvdmr:
            ...
            if ((drive->err = drive->cmd.transport(READ, drive->rd_buf, len))) {
                if (!drive->silent)
                    sperror("READ_DVD_STRUCTURE 10", drive->err);
                return 1;
            }
...
#warning DVD+RW total sectors reading
            ...
            if ((drive->err = drive->cmd.transport(READ, drive->rd_buf, len))) {
                if (!drive->silent)
                    sperror("READ_DVD_STRUCTURE 00", drive->err);
                return 1;
            }
    ...
    printf("Unknown media type, can't get available total capacity! Assuming "
           "value from READ_CAPACITY.\n");
    drive->media.capacity_total =
        drive->media.capacity + drive->media.capacity_free;
    return 0;
}
...
int read_spare_capacities(drive_info *drive) {
    ...
    if ((drive->err = drive->cmd.transport(READ, drive->rd_buf, 16)))
        if (!drive->silent) {
            sperror("READ_DVD_STRUCTURE 0A", drive->err);
            return 1;
        }
...
int read_capacities(drive_info *drive) {
    ...
    if (read_capacity_free(drive))
        printf("Error reading free capacity\n");
...
int read_disc_information(drive_info *drive) {
    ...
    len = (drive->rd_buf[0] << 8) | drive->rd_buf[1];
    if (!drive->silent)
        printf("Disc info length: 0x%04X\n  ", len);
    if (!drive->silent)
        for (i = 0; i < len + 2; i++) {
            printf(" 0x%02X", drive->rd_buf[i] & 0xFF);
            if (!((i + 1) % 8))
    ...
    if (!drive->silent) {
        ...
        printf("   Last session  lead-in  start: %d:%02d.%02d\n",
               (drive->rd_buf[16] << 8) | drive->rd_buf[17], drive->rd_buf[18],
               drive->rd_buf[19]);
        drive->media.last_lead_out = ((drive->rd_buf[20] & 0xFF) << 24) |
                                     (drive->rd_buf[21] * 75 * 60 +
                                      drive->rd_buf[22] * 75 + drive->rd_buf[23]);
        printf("   Last possible lead-out start: %d:%02d.%02d (sector 0x%08X)\n",
               (drive->rd_buf[20] << 8) | drive->rd_buf[21], drive->rd_buf[22],
               drive->rd_buf[23], drive->media.last_lead_out);
    }
    /*
...
int determine_cd_type(drive_info *drive) {
    ...
    if (ratip) {
        if (!drive->silent)
            printf("no ATIP found, assuming disc type: CD-ROM\n");
    ...
    if (drive->media.ATIP_size < 8) {
        if (!drive->silent)
            printf("ATIP too small, assuming disc type: CD-ROM\n");
        return DISC_CDROM; // CD-ROM
    }
    /*
    ...
    */
    ...
    if (cdrw) {
        if (!drive->silent)
            printf("disc type: CD-RW\n");
        return (DISC_CDRW | cd_subtype);
    }
    if (!drive->silent)
        printf("disc type: CD-R\n");
...
int read_mediaid_bd(drive_info *drive) {
    ...
    for (int i = 0; i < speed_tbl_size; i++)
        drive->parms.wr_speed_tbl_media[i] = -1;
    ...
    if ((drive->err = drive->cmd.transport(READ, drive->rd_buf, 4))) {
        if (!drive->silent)
            sperror("READ_BD_STRUCTURE 00", drive->err);
        return 1;
    }
...
int read_mediaid_dvdram(drive_info *drive) {
    ...
    for (i = 0; i < 12; i++)
        if (drive->media.MID[i] == 0)
            drive->media.MID[i] = 0x20;
...
int read_mediaid_dvdminus(drive_info *drive) {
    ...
    if ((drive->err = drive->cmd.transport(READ, header, 4))) {
        if (!drive->silent)
            sperror("READ_DVD_STRUCTURE 0E", drive->err);
        return 1;
    }
    len = (header[0] << 8 | header[1]) + 2;
    if (len > 68)
...
int read_mediaid_dvdplus(drive_info *drive) {
    ...
    if ((drive->err = drive->cmd.transport(READ, header, 4))) {
        if (!drive->silent)
            sperror("READ_DVD_STRUCTURE 11", drive->err);
        return 1;
    }
    len = (header[0] << 8 | header[1]) + 2;
    if (len > 260)
    ...
    if (drive->media.MID_raw[4 + 31] > 32) {
        drive->parms.wr_speed_tbl_media[wr_idx] =
            drive->media.MID_raw[4 + 32] / 14.58;
        wr_idx++;
    }
    for (int i = 0; i < 6; i++) {
        // if ((drive->media.MID_raw[4+18] & (1 << i)) &&
        // (drive->media.MID_raw[4+64+i*32] == (i+1) )) {
        if ((drive->media.MID_raw[4 + 18] & (1 << i)) &&
                (drive->media.MID_raw[4 + 64 + i * 32] > 0)) {
            //	printf("EI #%d\n",i);
            drive->parms.wr_speed_tbl_media[wr_idx] =
                drive->media.MID_raw[4 + 67 + i * 32] / 13.95;
            wr_idx++;
        }
    }
    return 0;
...
int read_mediaid_cd(drive_info *drive) {
    ...
    while (mi[idx].lin.m && nf)
        if (lin.m == mi[idx].lin.m && lin.s == mi[idx].lin.s &&
                lin.f == mi[idx].lin.f)
            nf = 0;
        else
            idx++;
    ...
    if (drive->mmc > 1) {
        ...
        if (drive->media.type & DISC_CD) {
            ...
            if ((drive->err = drive->cmd.transport(READ, drive->rd_buf, 36)))
                if (!drive->silent)
                    sperror("READ_DVD_STRUCTURE", drive->err);
            ...
            //			if (!drive->silent) printf("** Writer used:
            //'%s'\n",drive->media.writer);
            ...
            */
            ...
            if ((drive->rd_buf[17] & 0x0F) == 0)
                drive->media.gbpl = 25;
            else if ((drive->rd_buf[17] & 0x0F) == 1)
                drive->media.gbpl = 25;
            else if ((drive->rd_buf[17] & 0x0F) == 2)
                drive->media.gbpl = 27;
            else if ((drive->rd_buf[17] & 0x0F) == 5)
                drive->media.gbpl = 33;
...
int get_spindown(drive_info *drive) {
    ...
    if (drive->err) {
        drive->parms.spindown_idx = spindowns;
        return (drive->err);
    }
...
int get_performance(drive_info *drive, bool rw, uint8_t type) {
    ...
    if ((drive->err = drive->cmd.transport(READ, drive->rd_buf, 1024))) {
        if (!drive->silent)
            sperror("GET_PERFORMANCE", drive->err);
        return (drive->err);
    }
    //	return 1;
    ...
    if (type == 0x03)
        for (j = 0; j < speed_tbl_size; j++)
            drive->parms.wr_speed_tbl_kb[j] = -1;
    ...
    for (j = 0; j < min(descn, (type == 0x03) ? speed_tbl_size : descn); j++) {
        ...
        if (!type) {
            ...
            drive->parms.max_write_speed_kb =
                max(drive->parms.max_write_speed_kb, drive->parms.wr_speed_tbl_kb[j]);
        }
    }
    return 0;
}
...
int detect_speeds(drive_info *drive) {
    ...
    if (drive->media.type & (DISC_DVD | DISC_BD)) {
        ...
        if (!set_rw_speeds(drive)) {
            ...
            // if ( (!drive->wr_capabilities) && (drive->capabilities &
            ...
            if ((drive->capabilities & CAP_REAL_TIME_STREAMING)
                ...
                if (!drive->silent)
                    printf("Max DVD speed via GET_PERFORMANCE: %d X, %dkB/s\n",
                           drive->parms.max_read_speed_dvd,
                           drive->parms.max_read_speed_kb);
                ...
                if (drive->parms.speed_mult < 600) {
                    ...
                    drive->parms.max_read_speed_dvd =
                        (drive->parms.max_read_speed_kb / (BD ? 4494 : 1384));
        ...
        if (!set_rw_speeds(drive)) {
            ...
            if (!drive->silent)
                printf("Maximum CD speed: %dX, %5d kB/s; 1X = %.1f kB/s\nSpeeds:\n",
                       drive->parms.max_read_speed_cd, drive->parms.max_read_speed_kb,
                       drive->parms.speed_mult);
            idx = 0;
            prev_spd = 0;
            for (spd = 1; ((idx < speed_tbl_size) &&
    ...
    if (!speedidx) {
        while ((idx < speed_tbl_size) && (drive->parms.speed_tbl[idx] > 0)) {
            ...
            //			combo_Speed->insertItem(QString().sprintf("%2dX
            //(%dkB/s)",
            //				drive->parms.speed_tbl[idx],mlt*drive->parms.speed_tbl[idx]));
            if ((spd_kb / drive->parms.speed_mult) == drive->parms.speed_tbl[idx])
                speedidx = idx;
            idx++;
        }
    } else {
    ...
    for (int i = 0; i < speed_tbl_size && drive->parms.wr_speed_tbl_kb[i] > 0;
            i++) {
        if (!drive->silent)
...
int get_write_speed_tbl(drive_info *drive) {
    ...
    if (drive->capabilities & CAP_REAL_TIME_STREAMING) {
        ...
        offs = 0;
        while (((drive->rd_buf[offs]) & 0x3F) != 0x2A)
            offs++;
        ...
        for (i = 0; (i < spdcnt) && (i < speed_tbl_size); i++) {
            drive->parms.wr_speed_tbl_kb[i] =
                ntoh16(drive->rd_buf + offs + 32 + i * 4 + 2);
            drive->parms.max_write_speed_kb =
...
int get_rw_speeds(drive_info *drive) {
    ...
    /*
       ...
       PLEXTOR drives always returns maximum read speed via "get performance", not
       current!
    ...
    */
    ...
    if (!drive->get_performance_fail
            ...
            && (drive->capabilities & CAP_REAL_TIME_STREAMING)) {
        if (!drive->silent)
            printf("Requesting curerent speeds via GET_PERFORMANCE command...\n");
    ...
    if (!drive->silent)
        printf("Requesting curerent speeds via page 2A...\n");
...
int set_streaming(drive_info *drive) {
    ...
    if (drive->parms.read_speed_kb)
        speed_rd = drive->parms.read_speed_kb;
    if (drive->parms.write_speed_kb)
        speed_wr = drive->parms.write_speed_kb;
    ...
    *write_size = ntoh32(speed_wr);
    ...
    if ((drive->err = drive->cmd.transport(WRITE, data, 28))) {
        if (!drive->silent)
            sperror("SET_STREAMING", drive->err);
        return (drive->err);
    }
    return 0;
}
...
int set_rw_speeds(drive_info *drive) {
    ...
    if ((drive->capabilities & CAP_REAL_TIME_STREAMING)) {
        // if ((drive->capabilities & CAP_REAL_TIME_STREAMING) &&
        // !(drive->media.type & DISC_CD)) { if ((drive->capabilities &
        // CAP_REAL_TIME_STREAMING) && !(drive->media.type & DISC_DVDRAM)) {
        if (!drive->silent)
            printf("Setting speeds via SET_STREAMING command...\n");
        rez = set_streaming(drive);
    }
    if (rez) {
        if (!drive->silent)
            printf("Setting speeds via SET_CD_SPEED command...\n");
    ...
    #else
        if ((drive->capabilities & CAP_SET_CD_SPEED) )//&& (drive->media.type &
    DISC_CD)) { if ((rez = set_cd_speed(drive))) rez = set_streaming(drive); }
...
int get_media_status(drive_info *drive) {
    ...
    drive->cmd[8] = 8;
    if ((drive->err = drive->cmd.transport(READ, drive->rd_buf, 8))) {
        sperror("GET_EVENT_STATUS", drive->err);
        return (drive->err);
    }
    if (drive->rd_buf[5] & 0x01)
        drive->parms.status |= STATUS_OPEN;
    else
        drive->parms.status &= (~STATUS_OPEN);
    if (drive->rd_buf[5] & 0x02)
        drive->parms.status |= STATUS_MEDIA_PRESENT;
    else
        drive->parms.status &= (~STATUS_MEDIA_PRESENT);
...
int start_stop(drive_info *drive, bool start) {
    ...
    if ((drive->err = drive->cmd.transport(NONE, NULL, 0))) {
        sperror("START_STOP_UNIT", drive->err);
        return (drive->err);
    }
    return 0;
}
...
int get_lock(drive_info *drive) {
    ...
    if (mode_sense(drive, 0x2A, 0, 256)) {
        sperror("GET_LOCK", drive->err);
        return (drive->err);
    }
    offs = 0;
    while (((drive->rd_buf[offs]) & 0x3F) != 0x2A)
        offs++;
    if (drive->rd_buf[offs + 6] & 0x02)
        drive->parms.status |= STATUS_LOCK;
    else
        drive->parms.status &= (~STATUS_LOCK);
    //#ifndef __PXCONTROL
...
int play_audio_msf(drive_info *drive, msf beg, msf end) {
    ...
    drive->cmd[8] = end.f;
    if ((drive->err = drive->cmd.transport(NONE, NULL, 0))) {
        sperror("PLAY_AUDIO_MSF", drive->err);
        return (drive->err);
    }
    return 0;
}
...
int seek(drive_info *drive, int32_t lba, unsigned char flags) {
    ...
    drive->cmd[9] = flags;
    if ((drive->err = drive->cmd.transport(NONE, NULL, 0))) {
        sperror("SEEK", drive->err);
        return (drive->err);
    }
    return 0;
}

int read_cd(drive_info *drive, unsigned char *data, int32_t lba,
            int sector_count, unsigned char flags, unsigned char FUA) {
...
int read(drive_info *drive, unsigned char *data, int32_t lba, int sector_count,
         unsigned char FUA) {
    //	int transfer_length = sector_count * 3072;
...
int read_one_ecc_block(drive_info *drive, unsigned char *data, int32_t lba) {
    ...
    if ((drive->err = drive->cmd.transport(READ, data, 0x8000))) {
        sperror("READ_ONE_ECC_BLOCK", drive->err);
        return (drive->err);
    }
...
int get_drive_serial_number(drive_info *drive) {
    ...
    unsigned int length;
    get_configuration(drive, FEATURE_LOGICAL_UNIT_SERIAL_NUMBER, &data_length,
                      NULL);
    if (drive->err)
        return -1;
    length = drive->rd_buf[11];
    drive->rd_buf[12 + length] = 0;
    if (data_length > 8)
        strncpy(drive->serial, (char *)drive->rd_buf + 12, 16);
    else
        drive->serial[0] = 0;
    return 0;
}
...
int get_buffer_capacity(drive_info *drive) {
    int offs;
    if (mode_sense(drive, MODE_PAGE_MM_CAP_STATUS, 0, 192))
        return 1;
    offs = 0;
    while (((drive->rd_buf[offs]) & 0x3F) != 0x2A)
        offs++;
...
int get_wbuffer_capacity(drive_info *drive, uint32_t *btot, uint32_t *bfree) {
    ...
    if ((drive->err = drive->cmd.transport(READ, td, 0x0C))) {
        sperror("READ_BUFFER_CAPACITY", drive->err);
        return (drive->err);
    }
...
int detect_mm_capabilities(drive_info *drive) {
    ...
    if (!drive->silent)
        printf("CD parameters page length: 0x%02X\n", len);
    if (len >= 28) {
        drive->mmc = 3;
    } else if (len >= 24) {
        drive->mmc = 2;
    ...
    if (!drive->silent)
        for (i = offs; i < (offs + len + 2); i += 8) {
            for (j = 0; j < 8; j++)
                printf(" %02X", drive->rd_buf[i + j] & 0xFF);
            printf("\n");
        }
    //	if (drive->mmc) drive->rd_capabilities|=DEVICE_CD_ROM;
    if (drive->rd_buf[offs + 2] & 0x01)
        drive->rd_capabilities |= DEVICE_CD_R;
    if (drive->rd_buf[offs + 2] & 0x02)
        drive->rd_capabilities |= DEVICE_CD_RW;

    if (drive->rd_buf[offs + 3] & 0x01)
        drive->wr_capabilities |= DEVICE_CD_R;
    if (drive->rd_buf[offs + 3] & 0x02)
        drive->wr_capabilities |= DEVICE_CD_RW;
    if (drive->rd_buf[offs + 3] & 0x04)
        drive->capabilities |= CAP_TEST_WRITE_CD;

    if (drive->rd_buf[offs + 4] & 0x01)
        drive->capabilities |= CAP_CD_AUDIO;
    if (drive->rd_buf[offs + 4] & 0x02)
        drive->capabilities |= CAP_COMPOSITE;
    if (drive->rd_buf[offs + 4] & 0x04)
        drive->capabilities |= CAP_DIGITAL_PORT_1;
    if (drive->rd_buf[offs + 4] & 0x08)
        drive->capabilities |= CAP_DIGITAL_PORT_2;
    if (drive->rd_buf[offs + 4] & 0x10)
        drive->capabilities |= CAP_MODE2_FORM1;
    if (drive->rd_buf[offs + 4] & 0x20)
        drive->capabilities |= CAP_MODE2_FORM2;
    if (drive->rd_buf[offs + 4] & 0x40)
        drive->capabilities |= CAP_MULTISESSION;
    if (drive->rd_buf[offs + 4] & 0x80)
        drive->capabilities |= CAP_BURN_FREE;

    if (drive->rd_buf[offs + 5] & 0x01)
        drive->capabilities |= CAP_DAE;
    if (drive->rd_buf[offs + 5] & 0x02)
        drive->capabilities |= CAP_ACCURATE_STREAM;
    if (drive->rd_buf[offs + 5] & 0x10)
        drive->capabilities |= CAP_C2;
    if (drive->rd_buf[offs + 5] & 0x20)
        drive->capabilities |= CAP_ISRC;
    if (drive->rd_buf[offs + 5] & 0x40)
        drive->capabilities |= CAP_UPC;
    if (drive->rd_buf[offs + 5] & 0x80)
        drive->capabilities |= CAP_READ_BAR_CODE;

    if (drive->rd_buf[offs + 6] & 0x01)
        drive->capabilities |= CAP_LOCK;
    if (drive->rd_buf[offs + 6] & 0x08)
        drive->capabilities |= CAP_EJECT;

    drive->loader_id = (drive->rd_buf[offs + 6] >> 5) & 0x07;

    if (drive->rd_buf[offs + 7] & 0x10)
        drive->capabilities |= CAP_SIDE_CHANGE;

    switch (drive->mmc) {
    case 3:
        drive->parms.write_speed_kb = ntoh16u(drive->rd_buf + 36);
    case 2:
        if (drive->rd_buf[offs + 2] & 0x08)
            drive->rd_capabilities |= DEVICE_DVD_ROM;
        if (drive->rd_buf[offs + 2] & 0x10)
            drive->rd_capabilities |= DEVICE_DVD_R;
        if (drive->rd_buf[offs + 2] & 0x20)
            drive->rd_capabilities |= DEVICE_DVD_RAM;
        if (drive->rd_buf[offs + 3] & 0x10)
            drive->wr_capabilities |= DEVICE_DVD_R;
        if (drive->rd_buf[offs + 3] & 0x20)
            drive->wr_capabilities |= DEVICE_DVD_RAM;
    case 1:
    ...
    if (!drive->silent)
        printf("Max speeds:\tR@%dKBps / W@%dKBps\nCurrent speeds:\tR@%dKBps / "
               "W@%dKBps\n",
...
int convert_to_ID(drive_info *drive) {
    ...
    if (!strncmp(drive->ven, "PLEXTOR ", 8)) {
        ...
        else if (!strncmp(drive->dev, "CD-R   PX-W5224A", 16))
            drive->dev_ID = PLEXTOR_5224;
        else if (!strncmp(drive->dev, "CD-R   PREMIUM2", 15))
            drive->dev_ID = PLEXTOR_PREMIUM2;
        else if (!strncmp(drive->dev, "CD-R   PREMIUM", 14))
            drive->dev_ID = PLEXTOR_PREMIUM;
        else if (!strncmp(drive->dev, "DVDR   PX-708A2", 15))
            drive->dev_ID = PLEXTOR_708A2;
        else if (!strncmp(drive->dev, "DVDR   PX-712A", 14))
            drive->dev_ID = PLEXTOR_712;
        else if (!strncmp(drive->dev, "DVDR   PX-714A", 14))
            drive->dev_ID = PLEXTOR_716;
        else if (!strncmp(drive->dev, "DVDR   PX-716A ", 15))
            drive->dev_ID = PLEXTOR_716;
        else if (!strncmp(drive->dev, "DVDR   PX-716AL", 15))
            drive->dev_ID = PLEXTOR_716AL;
        else if (!strncmp(drive->dev, "DVDR   PX-755A", 14))
            drive->dev_ID = PLEXTOR_760;
        else if (!strncmp(drive->dev, "DVDR   PX-760A", 14))
            drive->dev_ID = PLEXTOR_760;
        else if (!strncmp(drive->dev, "CD-R   ", 8))
            drive->dev_ID = PLEXTOR_OLD;
        else {
            drive->ven_ID = DEV_GENERIC;
            drive->dev_ID = 0;
        }
...
int plextor_px755_do_auth(drive_info *dev) {
    if (!isPlextorLockPresent(dev)) {
        if (!dev->silent)
            printf("Plextor dev is older than PX-755, auth not needed\n");
        return 0;
    }
    ...
    if (plextor_px755_send_auth_code(dev, dev->rd_buf)) {
        ...
        if (!dev->silent)
            printf("PX-755/PX-760/Premium-II auth successfull:)\n");
        return 0;
    }
}
...
int plextor_px755_get_auth_code(drive_info *dev, unsigned char *auth_code) {
    ...
    if ((dev->err = dev->cmd.transport(READ, auth_code, 16))) {
        if (!dev->silent)
            sperror("PLEXTOR_PX755_GET_AUTH_CODE", dev->err);
        return dev->err;
    }
    if (!dev->silent) {
...
int plextor_px755_send_auth_code(drive_info *dev, unsigned char *auth_code) {
    ...
    if ((dev->err = dev->cmd.transport(WRITE, auth_code, 16))) {
        if (!dev->silent)
            sperror("PLEXTOR_PX755_SEND_AUTH_CODE", dev->err);
        return dev->err;
    }
    return 0;
}
...
int scan_plextor::cmd_px755_clear_auth_status(drive_info* dev)
{
        ...
        if ((dev->err=dev->cmd.transport(NONE,NULL,0) ))
                { if (!dev->silent) sperror
("PLEXTOR_PX755_CLEAR_AUTH_STATUS",dev->err); return dev->err;} return 0;
}
*/
